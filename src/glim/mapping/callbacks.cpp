...
CallbackSlot<void(int, int, int, const std::string&)> GlobalMappingCallbacks::on_relocalization_progress;
CallbackSlot<void(const Eigen::Isometry3d&, int, bool)> GlobalMappingCallbacks::on_relocalization_candidate;
